...
// source: lunadelegator/delegator/packet.proto
...
func (m *DelegatorPacketData) Reset()         { *m = DelegatorPacketData{} }
func (m *DelegatorPacketData) String() string { return proto.CompactTextString(m) }
func (*DelegatorPacketData) ProtoMessage()    {}
func (*DelegatorPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_96e26f3ca5e5b1d3, []int{0}
}
func (m *DelegatorPacketData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DelegatorPacketData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DelegatorPacketData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *DelegatorPacketData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DelegatorPacketData.Merge(m, src)
}
func (m *DelegatorPacketData) XXX_Size() int {
	return m.Size()
}
func (m *DelegatorPacketData) XXX_DiscardUnknown() {
	xxx_messageInfo_DelegatorPacketData.DiscardUnknown(m)
}

var xxx_messageInfo_DelegatorPacketData proto.InternalMessageInfo

type isDelegatorPacketData_Packet interface {
	isDelegatorPacketData_Packet()
...
func (m *DelegatorPacketData) GetNoData() *NoData {
	if x, ok := m.GetPacket().(*DelegatorPacketData_NoData); ok {
		return x.NoData
	}
	return nil
}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return fileDescriptor_96e26f3ca5e5b1d3, []int{1}
}
...
func (m *IbcDelegationPacketAck) Reset()         { *m = IbcDelegationPacketAck{} }
...
func (m *IbcDelegationPacketAck) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IbcDelegationPacketAck.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IbcDelegationPacketAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IbcDelegationPacketAck.Merge(m, src)
}
func (m *IbcDelegationPacketAck) XXX_Size() int {
	return m.Size()
}
func (m *IbcDelegationPacketAck) XXX_DiscardUnknown() {
	xxx_messageInfo_IbcDelegationPacketAck.DiscardUnknown(m)
}

var xxx_messageInfo_IbcDelegationPacketAck proto.InternalMessageInfo

func (m *IbcDelegationPacketAck) GetValidator() string {
	if m != nil {
		return m.Validator
	}
	return ""
...
func init() {
	proto.RegisterFile("lunadelegator/delegator/packet.proto", fileDescriptor_96e26f3ca5e5b1d3)
}
...
var fileDescriptor_96e26f3ca5e5b1d3 = []byte{
	...
	,
}
...
func (m *DelegatorPacketData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DelegatorPacketData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DelegatorPacketData_NoData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DelegatorPacketData_NoData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoData != nil {
		{
...
func (m *IbcDelegationPacketAck) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IbcDelegationPacketAck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Validator) > 0 {
		...
		i = encodeVarintPacket(dAtA, i, uint64(len(m.Validator)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *DelegatorPacketData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DelegatorPacketData_NoData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DelegatorPacketData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: DelegatorPacketData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DelegatorPacketData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Packet = &DelegatorPacketData_NoData{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *IbcDelegationPacketAck) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IbcDelegationPacketAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IbcDelegationPacketAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
